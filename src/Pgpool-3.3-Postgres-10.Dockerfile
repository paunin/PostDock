...
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/p/pgpool2/libpgpool0_3.3.4-1.pgdg70+1_amd64.deb" "libpgpool0"
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/p/pgpool2/pgpool2_3.3.4-1.pgdg70+1_amd64.deb" "pgpool2"
