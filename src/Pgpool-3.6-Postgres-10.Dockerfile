...
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/p/pgpool2/libpgpool0_3.6.7-1.pgdg90+1_amd64.deb" "libpgpool0"
RUN install_deb_pkg "https://apt-archive.postgresql.org/pub/repos/apt/pool/main/p/pgpool2/pgpool2_3.6.7-1.pgdg90+1_amd64.deb" "pgpool2"
