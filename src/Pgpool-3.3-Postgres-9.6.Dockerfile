...
ARG PGPOOL_PACKAGE_VERSION=3.3.4\*
...
RUN  apt-get install -y libffi-dev libssl-dev postgresql-client-9.6=9.6\* libpgpool0=$PGPOOL_PACKAGE_VERSION pgpool2=$PGPOOL_PACKAGE_VERSION openssh-server
